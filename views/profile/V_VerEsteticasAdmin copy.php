        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="col-md d-flex justify-content-between align-items-center ms-4">
                                <p class="text-muted">Fecha Cita</p>
                    ...
                    <?php
                    require_once('../../controllers/C_verEsteticasAdmin.php');
                        ...
                        <div class="col-md">
                            <div class="card mb-4 mb-lg-0">
                                <div class="card-body d-flex justify-content-between align-items-center p-3">
                                    ...
                                    <p class="mb-0"><?php echo $data['HORA_INICIO']; ?></p>
                                    <p class="mb-0"><?php echo $data['HORA_FIN']; ?></p>
                    ...
                    <div class="row">
                        <div class="col-md">
                            <form action="/Integrador/controllers/C_registrarDesparasitacion.php" method="POST">
                                <button type="button" class="btn btn-patitas" data-bs-toggle="modal" data-bs-target="#exampleModal">Agendar Baño/Corte</button>
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h3 class="modal-title" id="exampleModalLabel">Agendar Baño/Corte</h3>
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <?php require_once("../../controllers/C_verEsteticaTipoForm.php") ?>
                                                    <div class="col-md-6">
                                                        <h6>Mascota</h6>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <h6>Tipo</h6>
                                                        <select class="form-select" name="tipo_estetica" required>
                                                            <?php foreach($esteticas_tipos as $data) { ?>
                                                                <option value="<?php echo $data['ID_ETIPOS']; ?>"><?php echo $data['NAME_ETIPOS']; ?> - S/<?php echo $data['PRECIO_ETIPOS']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
