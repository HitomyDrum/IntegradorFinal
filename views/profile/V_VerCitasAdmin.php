        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <?php
                    require_once('../../controllers/C_verCitas.php');
                    foreach($citas as $data) { ?>
                    <div class="row mb-1">
                        <div class="col-md">
                            <div class="card mb-4 mb-lg-0">
                                <div class="card-body d-flex justify-content-between align-items-center p-3">
                                    <p class="mb-0"><?php echo $data['ID_CITA']; ?></p>
                                    <p class="mb-0"><?php echo $data['COMENT_CITA']; ?></p>
                                    <p class="mb-0"><?php echo $data['FECH_CITA']; ?></p>
                                    <p class="mb-0 alert alert-success">Activo</p>
