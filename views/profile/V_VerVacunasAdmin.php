        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <?php
                    require_once('../../controllers/C_verVacunasAdmin.php');
                    foreach($vacunas as $data) { ?>
                    <div class="row mb-1">
                        <div class="col-md">
                            <div class="card mb-4 mb-lg-0">
                                <div class="card-body d-flex justify-content-between align-items-center p-3">
                                    <p class="mb-0"><?php echo $data['NOM_VACUNA']; ?></p>
                    ...
                    <div class="row">
                        <div class="col-md">
                            <form action="/Integrador/controllers/C_registrarVacuna.php" method="POST">
                                <button type="button" class="btn btn-patitas" data-bs-toggle="modal" data-bs-target="#exampleModal">Programar Vacuna</button>
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h3 class="modal-title" id="exampleModalLabel">Programar Vacuna</h3>
