                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="col-md d-flex justify-content-between align-items-center ms-4">
                                ...
                                <p class="text-muted">Ruc Proveedor</p>
                                <p class="text-muted">Stock</p>
                            </div>
                        </div>
                    </div>
                    <?php
                    require_once('../../controllers/C_verProductosAdmin.php');
                    foreach($productos as $data) { ?>
                    <div class="row mb-1">
                        <div class="col-md">
                            <div class="card mb-4 mb-lg-0">
                                <div class="card-body d-flex justify-content-between align-items-center p-3">
                                    <p class="mb-0"><?php echo $data['NOM_PROD']; ?></p>
                                    <p class="mb-0 alert alert-success">S/<?php echo $data['PREC_UNIT']; ?></p>
                                    <p class="mb-0"><?php echo $data['RUC_PROV']; ?></p>
                                    <p class="mb-0"><?php echo $data['STOCK']; ?></p>
