<?php
    ...
    try {
        $queryTxt = "INSERT INTO `esteticas` (`ID_EST`, `ID_PET`, `DNI_VET`, `ID_ETIPOS`, `FECH_CITA`, `HORA_INICIO`, `HORA_FIN`, `PRECIO_FINAL`) VALUES (NULL, '$id_pet', '$dni_vet', '$tipo_estetica', '$fecha_cita', '$hora_inicio', '$hora_fin', '$precio_final');";
